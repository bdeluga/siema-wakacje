    ...
    if cityName.upper() not in check:        
        ...
        for data in data_acomodation1:
            if data['name']!='':
                if "wikidata" in data.keys():
                    ...
                    (str(uuid.uuid4()),data['name'].encode("utf-8"),data['rate'],'hotels',data['wikidata'],id,data['point']['lon'],data['point']['lat']))
                else:
                    cur.execute("INSERT INTO place VALUES(?,?,?,?,?,?,?,?)",
                    (str(uuid.uuid4()),data['name'].encode("utf-8"),data['rate'],'hotels','',id,data['point']['lon'],data['point']['lat']))
        con.commit()
        ...
        for data in data_acomodation2:
            if data['name']!='':
                if "wikidata" in data.keys():
                    cur.execute("INSERT INTO place VALUES(?,?,?,?,?,?,?,?)",
                    (str(uuid.uuid4()),data['name'].encode("utf-8"),data['rate'],'fun',data['wikidata'],id,data['point']['lon'],data['point']['lat']))
                else:
                    cur.execute("INSERT INTO place VALUES(?,?,?,?,?,?,?,?)",
                    (str(uuid.uuid4()),data['name'].encode("utf-8"),data['rate'],'fun','',id,data['point']['lon'],data['point']['lat']))
        con.commit()
        ...
        for data in data_acomodation3:
            if data['name']!='':
                if "wikidata" in data.keys():
                    cur.execute("INSERT INTO place VALUES(?,?,?,?,?,?,?,?)",
                    (str(uuid.uuid4()),data['name'].encode("utf-8"),data['rate'],'recreations',data['wikidata'],id,data['point']['lon'],data['point']['lat']))
                else:
                    cur.execute("INSERT INTO place VALUES(?,?,?,?,?,?,?,?)",
                    (str(uuid.uuid4()),data['name'].encode("utf-8"),data['rate'],'recreations','',id,data['point']['lon'],data['point']['lat']))
        con.commit()
        ...
        for data in data_acomodation4:
            if data['name']!='':
                if "wikidata" in data.keys():
                    cur.execute("INSERT INTO place VALUES(?,?,?,?,?,?,?,?)",
                    (str(uuid.uuid4()),data['name'].encode("utf-8"),data['rate'],'night_life',data['wikidata'],id,data['point']['lon'],data['point']['lat']))
                else:
                    cur.execute("INSERT INTO place VALUES(?,?,?,?,?,?,?,?)",
                    (str(uuid.uuid4()),data['name'].encode("utf-8"),data['rate'],'night_life','',id,data['point']['lon'],data['point']['lat']))
        con.commit()
        ...
        for data in data_acomodation5:
            if data['name']!='':
                if "wikidata" in data.keys():
                    cur.execute("INSERT INTO place VALUES(?,?,?,?,?,?,?,?)",
                    (str(uuid.uuid4()),data['name'].encode("utf-8"),data['rate'],'restaurants',data['wikidata'],id,data['point']['lon'],data['point']['lat']))
                else:
                    cur.execute("INSERT INTO place VALUES(?,?,?,?,?,?,?,?)",
                    (str(uuid.uuid4()),data['name'].encode("utf-8"),data['rate'],'restaurants','',id,data['point']['lon'],data['point']['lat']))
        con.commit()
        ...
        for data in data_acomodation6:
            if data['name']!='':
                if "wikidata" in data.keys():
                    cur.execute("INSERT INTO place VALUES(?,?,?,?,?,?,?,?)",
                    (str(uuid.uuid4()),data['name'].encode("utf-8"),data['rate'],'history',data['wikidata'],id,data['point']['lon'],data['point']['lat']))
                else:
                    cur.execute("INSERT INTO place VALUES(?,?,?,?,?,?,?,?)",
                    (str(uuid.uuid4()),data['name'].encode("utf-8"),data['rate'],'history','',id,data['point']['lon'],data['point']['lat']))
        con.commit()
        return "dodaned"
    return "Juz jest taki ziomal miasto"
def dbSelect():
    con = sqlite3.connect('Project.db')
    cur = con.cursor()
